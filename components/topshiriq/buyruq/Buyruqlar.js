        ...
        <ImageBackground source={require("../../../assets/newbg.jpg")} resizeMode="repeat" style={styles.profileBg}>
            <View style={styles.servicesContainer}>
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("Yangi buyruq")}
                >
                    <FontAwesome name={"inbox"} size={40} color={"white"} />
                    <Text style={styles.serviceText}>Yangi buyruq</Text>
                </TouchableOpacity>

                <TouchableOpacity
                    style={styles.service}
                    onPress={() => navigation.navigate("Jarayondagi buyruqlar")}
                >
                ...
                <TouchableOpacity
                    style={styles.service}
                    onPress={() => navigation.navigate("Kutilayotgan buyruqlar")}
                >
                ...
                <TouchableOpacity
                    style={styles.service}
                    onPress={() => navigation.navigate("Tugallangan buyruqlar")}
                >
